  ...
  stds = {
    ...
    factorio_data_stage = {
      read_globals = {
        ...
        default_tile_sounds_advanced_volume_control = {},
        defines = {
          fields = {
            alert_type = {
              fields = {
        ...
        sound_variations = {},
        sound_variations_with_volume_variations = {},
        string = {
          fields = {
            byte = {},
            char = {},
    ...
    factorio_lualib_circuit_connector_sprites = {
      read_globals = {
        ...
        furnace_circuit_wire_max_distance = {},
